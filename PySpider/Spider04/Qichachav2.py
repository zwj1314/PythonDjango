...
tag.click()
#将用户名、密码注入
driver.find_element_by_id('nameNormal').send_keys('15601806863')
driver.find_element_by_id('pwdNormal').send_keys('zhangjiaojiao!')
time.sleep(20)#休眠，人工完成验证步骤，等待程序单击“登录”
#单击登录按钮
