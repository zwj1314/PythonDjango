...
import random
from DouBanBook.settings import USER_AGENTS
from DouBanBook.settings import PROXIES
import base64
...
class RandomProxy(object):
    def process_request(self, request, spider):
        ...
        if proxy['user_passwd'] is None:
            ...
            base64_userpasswd = base64.b64encode(bytes(proxy['user_passwd'], encoding='utf-8'))
            request.meta['proxy'] = "http://" + proxy['ip_port']
